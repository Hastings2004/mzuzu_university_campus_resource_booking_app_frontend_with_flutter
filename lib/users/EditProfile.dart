...
import 'package:resource_booking_app/components/AppBar.dart'; // Assuming you have this AppBar
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  final TextEditingController _emailController = TextEditingController(); // For displaying, not usually for editing directly
  ...
  Future<void> _fetchUserData() async {
    try {
      ...
      if (userDoc.exists) {
        ...
        _emailController.text = FirebaseAuth.instance.currentUser?.email ?? ''; // Get email from Firebase Auth
