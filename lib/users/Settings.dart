...
//       };
//       final response = await CallApi().putData(data, 'user/change-password'); // Adjust endpoint
//       final body = json.decode(response.body);
...
import 'package:flutter/material.dart';
import 'package:resource_booking_app/auth/Auth.dart'; // Assuming this leads to your AuthPage
import 'dart:convert'; // For JSON encoding/decoding
import 'package:shared_preferences/shared_preferences.dart'; // For managing session
import 'package:resource_booking_app/auth/Api.dart'; // Your custom API service
import 'package:resource_booking_app/components/AppBar.dart';
